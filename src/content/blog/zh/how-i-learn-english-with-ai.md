...
服务器端的 Obsidian 是怎么和我自己用的 Obsidian 同步的呢？我用的是 Syncthing，让我的 Mac 端，Windows 端以及我的安卓平板端的 Obsidian 目录 and 服务器端的 Obsidian 目录同步，然后再通过 iCloud 让 Mac 端的 Obsidian 目录和我的 iPhone Obsidian 目录同步 。
